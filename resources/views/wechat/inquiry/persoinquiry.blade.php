                    ...
                    <div class="weui-cell">
                        <div class="font14">
                            ...
                            <div class="pager-left">
                                @if($data["current"]>1)
                                    <div class="pager-pre"><a class="pager-nav" href="{{route('person.inquiry',array('id'=>$data["order_id"],'name'=>$report["name"],'page'=>--$data["current"]))}}">上一页</a></div>
                                @else
                            ...
                            <div class="pager-right">
                                @if($data["current"]<$report["pagination"]->totalPage)
                                    <div class="pager-next"><a class="pager-nav" href="{{route('person.inquiry',array('id'=>$data["order_id"],'name'=>$report["name"],'page'=>++$data["current"]))}}">下一页</a></div>
                                @else
...
<script>
    function tiaozhuan() {
        ...
        if (num>0&&num<=total)
        {
            var url="{{route('person.inquiry',array('id'=>$data["order_id"],'name'=>$report["name"]))}}";
