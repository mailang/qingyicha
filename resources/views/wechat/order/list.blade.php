...
<section class="qyc_container">
    <div class="page__bd">
        <div class="headTop">
            <a href="javascript:history.go(-1)" class="back"><i class="iconBack"></i></a><span>查询记录</span><a class="more"><i class="iconDian"></i><i class="iconDian"></i><i class="iconDian"></i></a>
        </div>
        <div class="weui-tab">
                   ...
                   @foreach($orderlist as $order)
                       <div style="border_bottom:0.01em solid #eee;">
                        ...
                        <div class="weui-cell__bd">
                            <p><a href="{{route('order.info',$order->id)}}">{{$order->pro_name}}</a></p>
